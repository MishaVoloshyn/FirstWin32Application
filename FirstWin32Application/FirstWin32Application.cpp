...
INT WINAPI _tWinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPTSTR lpszCmdLine, int nCmdShow)
{
	...
	hWnd = CreateWindowEx(
		...
		TEXT("Хэппи Хэппи"), // заголовок окна
	...
	MoveWindow(hWnd, (width - width / 2) / 2, (height - height / 2) / 2, width / 2, height / 2, SWP_SHOWWINDOW);
	SetWindowPos(hWnd, HWND_TOP, 200, 200, 300, 300, SWP_SHOWWINDOW);
	// 4. Отображение окна
